...
export function DeleteAuthorDialog({author}: DeleteAuthorDialogProps) {
    const [isOpen, setIsOpen] = useState(false);

    const {mutateAsync, isPending, isError, error} = useMutation({
        mutationFn: () => authorsClient.deleteAuthor(author.id),
        onSuccess: async () => {
            ...
            <DialogContent className="sm:max-w-[425px]">
                <div className="contents">
                    ...
                    <DialogDescription className="text-justify">
                        Are you sure you want to delete `{author.firstName} {author.lastName}` author?
                    ...
                    <DialogFooter>
                        ...
                        <Button disabled={isPending} onClick={handleClick}>Delete author</Button>
                    </DialogFooter>
                </div>
            </DialogContent>
        </Dialog>
